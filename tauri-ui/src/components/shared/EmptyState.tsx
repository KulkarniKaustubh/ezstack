import { Layers, FolderOpen, Monitor } from "lucide-react";
...
export function EmptyState({ type, onSelectRepo, onConnectRemote, onNewBranch }: EmptyStateProps) {
  if (type === "no-repo") {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center p-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          {onConnectRemote && (
            <Button variant="outline" onClick={onConnectRemote}>
